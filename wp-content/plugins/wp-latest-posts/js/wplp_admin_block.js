    ...
    $(document).ready(function () {
        ...
        function ThemeChange(object, first) {
            ...
            if (object.val().indexOf("masonry") > -1 || object.val().indexOf("material-vertical") > -1) {
                ...
                $(".theme-image-position, .theme-text-align, .theme-new-item, .pagination, .number-rows, .default-color-theme, .lazyloading-btn, .image-position, .crop-text").hide();
                ...
                $('#dfReadMore').parent().hide();

                // Show
                $("#animation").children(".white-content").show();

                $("#wplp-default-color, .theme-new-item").show();
                ...
                $(".theme-image-position, .theme-text-align, .theme-new-item, .number-rows, .translation-checkbox, .default-color-theme, .force-icon-hover, .more-btn-property, .image-position, .select-hover-icon").hide();
                ...
                $(".theme-text-align, .theme-new-item, .force-icon-hover, .more-btn-property, .number-columns , .number-rows, .pagination, .theme-image-position, .image-position , .default-color-theme").hide();
                ...
                $(".theme-text-align, .crop-text, .theme-new-item, .pagination, .number-rows, .more-btn-property, .theme-image-position, .image-position, .force-icon-hover").hide();
                ...
                $(".theme-text-align, .theme-new-item , .crop-text , .pagination, .number-columns , .number-rows, .autoanim-transition, .animation-transition,.more-btn-property, .lazyloading-btn, .theme-image-position, .theme-text-align, .image-position, .translation-checkbox").show();
            }
        ...
        for (var i = 0; i < wplp_input_lists.length; i++) {
            if (document.querySelector(wplp_input_lists[i]) !== null) {
                setInputFilter(document.querySelector(wplp_input_lists[i]), function(value) {
                    return /^-?\d*[.,]?\d*$/.test(value); }, "Must be a number", wplp_input_lists[i]);
            }
        }
    });
